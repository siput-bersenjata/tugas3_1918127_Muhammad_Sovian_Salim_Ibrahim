package com.example.tugas3_prak;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_profil:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new profilef()).commit();
                break;
            case R.id.nav_bisnis:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new bisnisf()).commit();
                break;
        }
